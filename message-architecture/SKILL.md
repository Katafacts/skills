...
description: "The critical-to-quality (CTQ) tree's need-driver-measure discipline pointed at your standing product message instead of a single deal: the buyer need at the top, the message pillar that addresses it, and a specific, already-proven number underneath — with any pillar that isn't proven yet named plainly rather than shipped as a confident-sounding claim. Use when: You have proof points that already worked in real deals (a value hypothesis, a case study, a deal A3 finding) and want to turn them into a standing message every rep and channel uses the same way. Not for: You don't have any proven deals yet — a value hypothesis for a real opportunity comes first; a message architecture generalizes from proof that already exists, it doesn't invent proof from nothing. You want a single deal's specific pitch — that's a value hypothesis; a message architecture is the standing version reused across every deal."
---
...
The critical-to-quality (CTQ) tree's need-driver-measure discipline pointed at your standing product message instead of a single deal: the buyer need at the top, the message pillar that addresses it, and a specific, already-proven number underneath — with any pillar that isn't proven yet named plainly rather than shipped as a confident-sounding claim.
