...
description: "A running log of customer quotes and observations, each tagged with a theme — drafted for you, yours to edit — so you can see at a glance which few things customers are actually telling you, not just a pile of unsorted notes. Use when: You have real customer quotes or observations — from interviews, support tickets, surveys, gemba sessions, or win-loss calls — and want to know what they add up to, not just where they're filed. You want a defensible, evidence-backed answer to 'what are customers actually saying' rather than the loudest anecdote in the room. Not for: You only have secondhand impressions of what customers think, not actual quotes or logged observations — go gather real evidence first; a log built from memory inherits every gap in that memory. You already know the theme you're looking for and just want to confirm it — an evidence log works best as genuine discovery, not confirmation of a conclusion you've already reached."
---
...
# Voice of the customer (VOC) evidence log
...
Full worked example, on-screen and as a downloadable .xlsx: https://www.katafacts.com/katas/voc-evidence-log
...
- **Ideal customer profile (ICP) canvas** (`icp-canvas`) — A named theme pattern — which customers say what, and why — is direct input to who an ICP should target or exclude.
...
Voice of the customer (VOC) evidence log is licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). Attribution: Katafacts (katafacts.com).
